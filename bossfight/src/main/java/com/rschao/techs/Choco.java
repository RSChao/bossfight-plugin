...
public class Choco {
    ...
    static Technique acrobatics = new Technique("acrobacias", "Acrobatics", false, cooldownHelper.minutesToMiliseconds(1), (player, itemStack, objects) -> {
        Player user = player;
        ...
        hotbarMessage.sendHotbarMessage(player, "You have used the Acrobatics technique!");
    });

    static Technique cards = new Technique("cartas", "Card Madness", false, cooldownHelper.minutesToMiliseconds(5), (player, itemStack, objects) -> {
    ...
    static Technique starstorm = new Technique("lluviaestelar", "Deck StarStorm", false, cooldownHelper.minutesToMiliseconds(10), (player, itemStack, objects) -> {
