...
public class weapons {
    ...
    static void OblivionEdge(){
        ...
        sr.setIngredient('G', new ExactChoice(com.rschao.smp.items.Items.GlitchArrow));
        sr.setIngredient('E', new ExactChoice(OblivionEssence));
        sr.setIngredient('S', Material.NETHERITE_SWORD);
        sr.setIngredient('H', new ExactChoice(com.rschao.smp.items.Items.HealthGem));
    ...
    static void Container(){
        ...
        sr.setIngredient('D', new ExactChoice(com.rschao.smp.items.Items.WitherPot));
    ...
    static void DimentioHelmet(){
        ...
        item = (new DimensionalManipEnchant()).addEnchant(item, 1);
        ItemMeta meta = item.getItemMeta();
    ...
    static void Devilsknife(){
        ...
        item = (new Devil()).addEnchant(item, 1);
        ItemMeta meta = item.getItemMeta();
    ...
    static void Chocoblade(){
        ...
        item = (new Choco()).addEnchant(item, 1);
        ItemMeta meta = item.getItemMeta();
