...
public class giveItems {
    ...
    public static CommandAPICommand CorruptedHeart(){
        CommandAPICommand cmd = new CommandAPICommand("c_heart")
                ...
                .withOptionalArguments(new IntegerArgument("amount", 1, 64))
                .executesPlayer((Player player, CommandArguments args) -> {
                    Integer Lv = (Integer) args.getOrDefault("level", 1);
                    Integer amountObj = (Integer) args.getOrDefault("amount", 1);
                    int amount = (amountObj != null) ? amountObj : 1;
                    switch (Lv){
                        case 1:
                            ...
                            break;
                        case 2:
                            addItem(player, weapons.CorruptedHeart2, amount);
                            break;
                        case 3:
                            addItem(player, weapons.CorruptedHeart3, amount);
                            break;
                        case 4:
                            addItem(player, weapons.CorruptedHeart4, amount);
                            break;
                        case 5:
                            addItem(player, weapons.CorruptedHeart5, amount);
                            break;
                    }
                });
        return cmd;
