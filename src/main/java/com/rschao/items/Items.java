...
public class Items {
    ...
    public static void addEnchants(){
        ...
        weapons.ChaoSword.setItemMeta(meta);
        meta = weapons.DeltaSword.getItemMeta();
        meta.addEnchant(Enchantment.getByKey(NamespacedKey.minecraft("oblivion")), 1, true);
        meta.addEnchant(Enchantment.getByKey(NamespacedKey.minecraft("glitch")), 1, true);
        weapons.DeltaSword.setItemMeta(meta);
    }
    static void Geno(){
