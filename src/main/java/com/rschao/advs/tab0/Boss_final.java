...
public class Boss_final extends BaseAdvancement implements HiddenVisibility {
  ...
  public Boss_final(Advancement parent, float x, float y) {
    super(KEY.getKey(), new AdvancementDisplay(item, "§lDestroyer of Darkness", AdvancementFrameType.CHALLENGE, true, true, x, y , "Defeat the holder of Darkness,", "the Broken Soul of Showdown"), parent, 1);
    ...
    public void giveReward(Player player) {
        Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "lp user "+player.getName()+" parent add bs-clearer");
        player.sendMessage("Your achievement shall not go unnoticed");
    }
}