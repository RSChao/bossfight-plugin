...
public class BossStartEvent extends Event implements Cancellable {
    ...
    public BossStartEvent(String bossName, int phase, Player boss, Player[] bossPlayers) {
    ...
    public String getWorldName(){
        ...
        return config.getString("boss.world.1.name");
    }
